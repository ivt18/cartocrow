#ifndef CARTOCROW_STENOMAP_BACKBONE_PAINTING_H
#define CARTOCROW_STENOMAP_BACKBONE_PAINTING_H
...
class BackbonePainting : public renderer::GeometryPainting {

    public:
        // Creates a new painting with the given medial axis
        BackbonePainting(medial_axis::MedialAxis medial_axis);
